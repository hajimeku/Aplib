package apollo.assetmanager.processproxy 
{
	...
	public class ProcessTextureBTM extends ProcessDefault
	{
		...
		public function ProcessTextureBTM(_asset:Asset, _bytes:ByteArray, _securityDomain:SecurityDomain = null, _applicationDomain:ApplicationDomain = null, _mipMaps:Boolean = false, _scale:Number = 1) 
		{
			this.scale 		= _scale;
			this.mipMaps 	= _mipMaps;
			super(_asset, _bytes, _securityDomain, _applicationDomain);
		}
